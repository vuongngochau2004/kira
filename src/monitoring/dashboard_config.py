...
Usage:
    from monitoring.dashboard_config import DashboardConfig
...
class DashboardConfig:
    ...
    def get_metrics_by_category(self, category: str) -> dict[str, MetricDefinition]:
        ...
        Returns:
            Dictionary of metrics in category
        """
        return {
            name: metric
    ...
    def check_alerts(self, current_metrics: dict[str, float]) -> list[dict[str, Any]]:
        ...
        Args:
            current_metrics: Dictionary of metric name -> value
    ...
    def get_trend_config(self, window: str = "medium") -> dict[str, Any]:
        ...
        Args:
            window: Trend window (short, medium, long)
        ...
        return {
            ...
            "min_data_points": 6,  # At least 6 data points for trend
        }
