...
from agents.llm import chat_async, chat_async_stream, chat_async_with_tools
...
from agents.utils import format_context
from agents.citation_parser import CitationParser
...
from models.responses import DocumentSource, SourceChunk, SourceMetadata, GroupedDocumentResponse
from config.config import settings
from constants import MAX_CONTEXT_TOKENS, MIN_CONTEXT_LENGTH, MIN_RETRIEVAL_SCORE, MIN_RETRIEVAL_DOCS
...
class AgenticRAG:
    ...
    async def _resolve_document_titles(self, docs: list[dict]) -> dict[str, str]:
        ...
        from indexing.document_store import get_documents_batch
