...
This module now contains BOTH ports AND data models (Intent, ClassificationResult).
Previously, data models were in src.protocols.classification - now unified in ABC-only architecture.

Example:
    >>> from src.shared.ports.classification import ClassificationCacheBase, ClassificationStrategyBase
    >>>
