...
# Import retrieval services for actual document retrieval
...
class RetrievalAgent:
    ...
    async def _retrieve_documents(
        ...
        try:
            ...
            query_embedding = embed_single(primary_query)

            # Get BM25 index for user
            bm25_manager = get_bm25_manager()
            bm25_index = bm25_manager.get_index(user_id) if bm25_manager else None
