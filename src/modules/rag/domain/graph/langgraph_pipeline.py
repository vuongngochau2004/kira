...
from src.modules.rag.domain.agents.orchestrator_agent import OrchestratorAgent
from src.modules.rag.domain.agents.retrieval_agent import RetrievalAgent
from src.modules.rag.domain.agents.generation_agent import GenerationAgent
from src.modules.rag.domain.agents.quality_agent import QualityAgent
...
class LangGraphRAGPipeline:
    ...
    def __init__(
        ...
        self.generation_agent = GenerationAgent(generation_config)
        self.quality_agent = QualityAgent(quality_config)
