...
def main():
    ...
    for p in ax.patches:
        ...
        if width > 0.1: # Skip zero values
            ...
            # We can label with both Percentage and Count
            ax.text(
                width + 0.3,
    ...
    ax.set_title(
        "SO SÁNH PHÂN PHỐI LĨNH VỰC TÀI LIỆU\nTẬP GỐC (456 FILE) vs TẬP MẪU (43 FILE)",
        fontsize=16,
        fontweight='bold',
        pad=25,
        color='#1a1a1a'
