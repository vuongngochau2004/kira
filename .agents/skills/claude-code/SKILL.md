---
name: ckm:Codex
description: Activate when users ask about Codex installation, slash commands (/plan, /fix, /content, /docs, /design, /git), creating/managing Agent Skills, configuring MCP servers, setting up hooks/plugins, IDE integration (VS Code, JetBrains), CI/CD workflows, enterprise deployment (SSO, RBAC, sandboxing), troubleshooting authentication/performance issues, or advanced features (extended thinking, caching, checkpointing).
...
**Slash Commands**: User-defined operations in `.Codex/commands/` expanding to prompts
...
- Official docs: https://docs.Codex.com/en/docs/Codex/
