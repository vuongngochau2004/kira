...
```bash
# Open gallery
node .Codex/skills/content-hub/scripts/server.cjs --open

# Rescan assets
node .Codex/skills/content-hub/scripts/server.cjs --scan

# Stop server
node .Codex/skills/content-hub/scripts/server.cjs --stop
```
...
- **Actions**: Preview, Edit in Codex, Copy path, Generate new
