...
```bash
python3 .Codex/skills/creativity/scripts/search.py "<campaign_type> <audience> <industry>" --creative-brief [-c "Campaign Name"]
```
...
**Example:**
```bash
python3 .Codex/skills/creativity/scripts/search.py "SaaS product launch gen z" --creative-brief -c "App Launch Campaign"
```
...
```bash
python3 .Codex/skills/creativity/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 .Codex/skills/creativity/scripts/search.py "gen z saas product tiktok" --creative-brief -c "SaaS Launch"
```
...
python3 .Codex/skills/creativity/scripts/search.py "tiktok" --domain platform

# Get Gen Z style options
python3 .Codex/skills/creativity/scripts/search.py "gen z authentic raw" --domain style
```
...
python3 .Codex/skills/creativity/scripts/search.py "e-commerce launch" --creative-brief

# Markdown - best for documentation
python3 .Codex/skills/creativity/scripts/search.py "e-commerce launch" --creative-brief -f markdown
```
