...
1. Search niche-specific guidelines:
   ```bash
   python3 .Codex/skills/youtube-thumbnail-design/scripts/search.py "<niche keywords>" --design-brief -t "Video Title"
   ```

2. Search style recommendations:
   ```bash
   python3 .Codex/skills/youtube-thumbnail-design/scripts/search.py "<style keywords>" --domain style
   ```
...
**Single thumbnail:**
```bash
python3 .Codex/skills/youtube-thumbnail-design/scripts/generate.py \
