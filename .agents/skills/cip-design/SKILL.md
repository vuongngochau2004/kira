...
```bash
python3 ~/.Codex/skills/cip-design/scripts/search.py "tech startup" --cip-brief -b "BrandName"
```
...
```bash
# Search deliverables
python3 ~/.Codex/skills/cip-design/scripts/search.py "business card letterhead" --domain deliverable

# Search design styles
python3 ~/.Codex/skills/cip-design/scripts/search.py "luxury premium elegant" --domain style

# Search industry guidelines
python3 ~/.Codex/skills/cip-design/scripts/search.py "hospitality hotel" --domain industry

# Search mockup contexts
python3 ~/.Codex/skills/cip-design/scripts/search.py "office reception" --domain mockup
```
...
python3 ~/.Codex/skills/cip-design/scripts/generate.py --brand "TopGroup" --logo /path/to/logo.png --deliverable "business card" --industry "consulting"

# Generate full CIP set with logo
python3 ~/.Codex/skills/cip-design/scripts/generate.py --brand "TopGroup" --logo /path/to/logo.png --industry "consulting" --set

# Use Pro model for higher quality / 4K text rendering
python3 ~/.Codex/skills/cip-design/scripts/generate.py --brand "TopGroup" --logo logo.png --deliverable "business card" --model pro

# Custom deliverables with aspect ratio
python3 ~/.Codex/skills/cip-design/scripts/generate.py --brand "GreenLeaf" --logo logo.png --industry "organic food" --deliverables "letterhead,packaging,vehicle" --ratio 16:9

# Without logo (AI generates its own interpretation)
python3 ~/.Codex/skills/cip-design/scripts/generate.py --brand "TechFlow" --deliverable "business card" --no-logo-prompt
```
...
```bash
python3 ~/.Codex/skills/cip-design/scripts/search.py "luxury hospitality hotel" --cip-brief -b "Grand Vista"
```

2. Generate key deliverables with logo (RECOMMENDED):
```bash
python3 ~/.Codex/skills/cip-design/scripts/generate.py --brand "Grand Vista" --logo /path/to/grandvista-logo.png --industry "hospitality" --style "luxury premium" --set
```

3. Or without logo (AI generates interpretation):
```bash
python3 ~/.Codex/skills/cip-design/scripts/generate.py --brand "Grand Vista" --industry "hospitality" --style "luxury premium" --set --no-logo-prompt
```
...
python3 ~/.Codex/skills/cip-design/scripts/render-html.py --brand "TopGroup" --industry "consulting" --images /path/to/cip-output

# Specify custom output path
python3 ~/.Codex/skills/cip-design/scripts/render-html.py --brand "TopGroup" --industry "consulting" --images ./topgroup-cip --output presentation.html
```
