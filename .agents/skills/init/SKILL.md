...
|-------|------------|--------------|
| Researcher 1 | Product/Service Analysis | `README.md`, `AGENTS.md`, `package.json`, codebase |
...
1. **Analyze Available Commands**
   - Run `python .Codex/scripts/generate_catalogs.py --commands`
...
## Output
**IMPORANT**: Create/update following documents even docs exists in Step 1.2
- `AGENTS.md` - Updated with marketing context
