...
description: View markdown files with calm, book-like reading experience. Background HTTP server for rendering markdown.
...
node $HOME/.Codex/skills/markdown-novel-viewer/scripts/server.cjs --stop
```
