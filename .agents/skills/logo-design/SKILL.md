...
```bash
python3 ~/.Codex/skills/logo-design/scripts/search.py "tech startup modern" --design-brief -p "BrandName"
```
...
```bash
# Search styles
python3 ~/.Codex/skills/logo-design/scripts/search.py "minimalist clean modern" --domain style

# Search color palettes
python3 ~/.Codex/skills/logo-design/scripts/search.py "tech professional trust" --domain color

# Search industry guidelines
python3 ~/.Codex/skills/logo-design/scripts/search.py "healthcare medical" --domain industry
```
...
```bash
python3 ~/.Codex/skills/logo-design/scripts/generate.py --brand "TechFlow" --style minimalist --industry tech
python3 ~/.Codex/skills/logo-design/scripts/generate.py --prompt "coffee shop vintage badge" --style vintage
```
...
```bash
python3 ~/.Codex/skills/logo-design/scripts/search.py "coffee organic eco sustainable" --design-brief -p "GreenBean"
```
...
```bash
python3 ~/.Codex/skills/logo-design/scripts/generate.py --brand "GreenBean" --style vintage --industry eco
python3 ~/.Codex/skills/logo-design/scripts/generate.py --brand "GreenBean" --style organic --industry food
```
