...
Credentials: `.Codex/secrets/ga_service_account.json` or `google_client_secret.json`

### Scripts
| Script | Purpose |
|--------|---------|
| `scripts/ga-config-loader.cjs` | Load credentials from .Codex/secrets |
...
```bash
# List accounts
node .Codex/skills/analytics/scripts/ga-list-accounts.cjs --summaries

# Run report
node .Codex/skills/analytics/scripts/ga-run-report.cjs \
