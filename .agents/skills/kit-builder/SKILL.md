...
|------|----------|---------|
| Skill | `.Codex/skills/{name}/SKILL.md` | Domain knowledge + tools |
| Agent | `.Codex/agents/{name}.md` | Specialized subagent |
| Command | `.Codex/commands/{path}.md` | User-invocable action |
| Workflow | `.Codex/workflows/{name}.md` | Process orchestration |
...
```bash
python .Codex/skills/kit-builder/scripts/init_component.py <type> <name>
```
