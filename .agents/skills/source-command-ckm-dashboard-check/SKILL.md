---
name: "source-command-ckm-dashboard-check"
description: "Check Marketing Dashboard server status"
---

# source-command-ckm-dashboard-check

Use this skill when the user asks to run the migrated source command `ckm-dashboard-check`.
...
To start: /dashboard
To start manually:
  cd .Codex/skills/marketing-dashboard
  ./start.sh
```
